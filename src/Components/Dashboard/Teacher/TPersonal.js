...
<div className="col offset-s5 center"><div >Personal Information</div> </div><div className="col right"> <Link className="btn green white-text" to='/tpersonale'>Edit</Link></div>
...
<div className="row s1 ">
    <div className="col s2"> Under Graduate</div><div className="col s1">
                    ...
                    <div className="col s2">
                    <div ><span>College : </span>
               {this.state.ugc}
                </div>
                    </div>
                    <div className="col ">
                    <div ><span>Degree and stream : </span>
               {this.state.ugd}
                </div>
                    </div>
</div>
